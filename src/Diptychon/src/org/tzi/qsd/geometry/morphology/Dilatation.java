...
/**
 * An dilatation operation for binary raster images.
 */
public class Dilatation extends MorphologicalOperation {

    /**
     * Constructs a dilatation for a given binary raster image with a standard
     * mask.
     * 
     * @param image
     *            the binary raster image to be dilated
     */
    public Dilatation(final GrayImage image) {
        super(image);
    }

    /**
     * Constructs a dilatation for a given binary raster image with a given
     * mask.
     * 
     * @param image
     *            the binary raster image to be dilated
     ...
     */
    public Dilatation(final GrayImage image, final boolean[][] mask) {
        super(image, mask);
    }
